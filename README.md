...
- **Browser MCP Shim**: Review, install, pin, smoke-test, and probe compatible JS package imports from the local VFS
...
- **Network/VFS Audit Views**: Inspect configured network surfaces and session VFS changes
