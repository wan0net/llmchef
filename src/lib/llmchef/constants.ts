...
// initial app load. Hosts that need Python should serve Pyodide under the app
// base path or provide another same-origin VITE_PYODIDE_CDN_URL.
...
export const PYODIDE_CDN_BASE_URL = import.meta.env.VITE_PYODIDE_CDN_URL || `${import.meta.env.BASE_URL}pyodide`;
