...
import type { DbPromptTemplate } from "@/types/llmchef/prompt-template";
import type { DbSkill } from "@/types/llmchef/skill";
...
export class LLMChefDatabase extends Dexie {
