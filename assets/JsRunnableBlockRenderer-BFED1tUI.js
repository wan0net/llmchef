const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DE517D4b.js","assets/vendor-diagrams-BYeK1Opv.js","assets/vendor-react-Du8Qqd40.js"])))=>i.map(i=>d[i]);
import{p as Ue,_ as Fe}from"./vendor-diagrams-BYeK1Opv.js";import{r as s,j as t,R as Je}from"./vendor-react-Du8Qqd40.js";import{P as He}from"./vendor-editor-BMKARdr8.js";import{u as $e,Q as we,b as A,ah as Qe,a6 as qe,a7 as De,a8 as Ae,a9 as ze,aa as ye,A as _,B as We,aj as Ke}from"./index-jT-_7t0Q.js";import{t as h,m as Ve,n as xe,M as be,i as ve,o as Ye,k as Ge,E as Xe,p as Ze,D as et,q as tt}from"./vendor-ui-Y3Sx1-Yh.js";import{C as rt}from"./code-security.service-YOR7xO9e.js";import"./vendor-data-Cg1t-RTV.js";import"./vendor-ai-Cpm0OBFa.js";let P=null;const ot=()=>window.llmChefQuickJS?.isReady&&window.llmChefQuickJS.QuickJS&&window.llmChefQuickJS.context?Promise.resolve({QuickJS:window.llmChefQuickJS.QuickJS,vm:window.llmChefQuickJS.context}):P||(window.llmChefQuickJS={isLoading:!0,isReady:!1,loadPromise:void 0,QuickJS:void 0,context:void 0},P=Fe(()=>import("./index-DE517D4b.js"),__vite__mapDeps([0,1,2])).then(async({getQuickJS:l})=>{const L=await l(),N=L.newContext();return window.llmChefQuickJS={isLoading:!1,isReady:!0,loadPromise:void 0,QuickJS:L,context:N},window.dispatchEvent(new CustomEvent("quickjs-ready",{detail:{QuickJS:L,vm:N}})),{QuickJS:L,vm:N}}).catch(l=>{throw window.llmChefQuickJS={isLoading:!1,isReady:!1,loadPromise:void 0,QuickJS:void 0,context:void 0},P=null,window.dispatchEvent(new CustomEvent("quickjs-error",{detail:l})),l}),window.llmChefQuickJS.loadPromise=P.then(()=>{}),P),nt=({code:l,isStreaming:L=!1,interactionId:N,blockId:F})=>{const{t:a}=$e("renderers"),{foldStreamingCodeBlocks:ke}=we(A(r=>({foldStreamingCodeBlocks:r.foldStreamingCodeBlocks}))),Q=we(A(r=>r.runnableBlocksEnabled)),[g,Ce]=s.useState(L?ke:!1),[m,z]=s.useState(!1),[p,W]=s.useState(l),[q,J]=s.useState(!1),[K,V]=s.useState([]),[T,j]=s.useState(!1),[y,E]=s.useState(!1),[Y,G]=s.useState(!1),[d,X]=s.useState(null),[Z,ee]=s.useState(!1),[B,I]=s.useState(0),[te,re]=s.useState(0),[x,Se]=s.useState("safe"),oe=s.useMemo(()=>F||`js-block-${Math.random().toString(36).substr(2,9)}`,[F]),[R,O]=s.useState(()=>typeof window<"u"&&window.llmChefQuickJS?window.llmChefQuickJS.isReady?"ready":window.llmChefQuickJS.isLoading?"loading":"idle":"idle"),S=s.useRef(null),n=s.useRef(null),U=s.useRef(null),ne=Qe(A(r=>Object.values(r.canvasControls)));s.useEffect(()=>{function r(){window.llmChefQuickJS?.isReady?O("ready"):window.llmChefQuickJS?.isLoading?O("loading"):O("idle")}function o(){O("ready")}function e(){O("error")}return window.addEventListener("quickjs-ready",o),window.addEventListener("quickjs-error",e),r(),()=>{window.removeEventListener("quickjs-ready",o),window.removeEventListener("quickjs-error",e)}},[]),s.useEffect(()=>{m||W(l)},[l,m]),s.useEffect(()=>{n.current&&U.current&&(!g&&y?(n.current.parentNode!==U.current&&U.current.appendChild(n.current),n.current.style.position="relative",n.current.style.top="0",n.current.style.left="0",n.current.style.width="100%",n.current.style.height="100%",n.current.style.visibility="visible",n.current.style.pointerEvents="auto",n.current.style.zIndex="1"):(n.current.parentNode===U.current&&document.body.appendChild(n.current),n.current.style.position="absolute",n.current.style.top="-9999px",n.current.style.left="-9999px",n.current.style.width="1px",n.current.style.height="1px",n.current.style.visibility="hidden",n.current.style.pointerEvents="none",n.current.style.zIndex="-1"))},[y,g]),s.useEffect(()=>{X(null),I(0),re(0)},[p]);const je=s.useCallback((r,o,e,i,u,M)=>ne.filter(b=>b.type==="codeblock"&&b.targetSlot===r&&b.renderer).map(b=>{if(b.renderer){const v={codeBlockContent:o,codeBlockEditedContent:p,codeBlockLang:"javascript",codeBlockFilepath:void 0,isFolded:u,toggleFold:M,canvasContextType:"codeblock",interactionId:N,blockId:F,onEditModeChange:z};return t.jsx(Je.Fragment,{children:b.renderer(v)},b.id)}return null}).filter(Boolean),[ne,p,N,F,z]),D=s.useCallback(()=>{if(S.current&&(m?p:l))try{S.current.style.whiteSpace!=="pre-wrap"&&(S.current.style.whiteSpace="pre-wrap"),S.current.textContent=m?p:l,He.highlightElement(S.current)}catch(r){console.error("Prism highlight error:",r),S.current.textContent=m?p:l}else S.current&&(S.current.textContent="")},[l,p,m]);s.useEffect(()=>{!g&&!T&&!y&&D()},[l,p,m,g,T,y,D]),s.useEffect(()=>()=>{if(n.current)try{n.current.querySelectorAll("iframe").forEach(o=>{const e=o.__llmchefMessageHandler;e&&(window.removeEventListener("message",e),delete o.__llmchefMessageHandler)}),n.current.innerHTML=""}catch{}},[]);const se=()=>{const r=g;Ce(o=>!o),r&&setTimeout(D,0)},Ee=s.useCallback(async()=>{ee(!0);try{const r=m?p:l,o=await rt.validateCodeSecurity(r,"javascript");X(o),o.score>90?h.error(`High-risk code detected (Score: ${o.score}/100). Please review carefully before running.`):o.score>60?h.warning(`Potentially risky code detected (Score: ${o.score}/100). Use caution when running.`):o.score>30?h.info(`Moderate-risk code detected (Score: ${o.score}/100). Review before running.`):h.success(`Code security check passed (Score: ${o.score}/100).`)}catch(r){console.error("Security check failed:",r),h.error(a("jsRunnableBlock.securityCheckFailed"))}finally{ee(!1)}},[l,p,m]),ie=s.useCallback(async(r,o)=>{const e=window.llmChefQuickJS.context;try{const i=e.newObject(),u=e.newObject(),M=e.newFunction("log",(...c)=>{const w=c.map(f=>e.dump(f));return o.push(w.join(" ")),e.undefined});e.setProp(u,"log",M),e.setProp(i,"utils",u);const b=e.newFunction("toast",c=>{const w=e.dump(c);return h(w),e.undefined});e.setProp(i,"toast",b);const v=new Map;let k=1;const de=()=>`qjsnode_${k++}`,ue=e.newFunction("__getRootId",()=>{let c=n.current.__qjs_id;return c||(c=de(),n.current.__qjs_id=c,v.set(c,n.current)),e.newString(c)});e.setProp(e.global,"__getRootId",ue);const me=e.newFunction("__createElement",c=>{const w=e.dump(c),f=document.createElement(w),C=de();return f.__qjs_id=C,v.set(C,f),e.newString(C)});e.setProp(e.global,"__createElement",me);const pe=e.newFunction("__appendChild",(c,w)=>{const f=v.get(e.dump(c)),C=v.get(e.dump(w));return f&&C&&f.appendChild(C),e.undefined});e.setProp(e.global,"__appendChild",pe);const fe=e.newFunction("__setTextContent",(c,w)=>{const f=v.get(e.dump(c));return f&&(f.textContent=e.dump(w)),e.undefined});e.setProp(e.global,"__setTextContent",fe);const ge=e.newFunction("__setInnerHTML",(c,w)=>{const f=v.get(e.dump(c));return f&&f instanceof Element&&(f.innerHTML=Ue.sanitize(e.dump(w),{USE_PROFILES:{html:!0}})),e.undefined});e.setProp(e.global,"__setInnerHTML",ge);const he=e.newFunction("__setStyle",(c,w,f)=>{const C=v.get(e.dump(c));return C&&C instanceof HTMLElement&&(C.style[e.dump(w)]=e.dump(f)),e.undefined});e.setProp(e.global,"__setStyle",he),e.setProp(e.global,"llmchef",i);const H=e.evalCode(`
